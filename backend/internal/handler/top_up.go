...
func RefundTopUp(c *gin.Context) {
	...
	if err := service.RefundTopUp(id); err != nil {
		c.JSON(http.StatusBadRequest, models.ErrorResp("REFUND_FAILED", err.Error(), ""))
		return
	}
